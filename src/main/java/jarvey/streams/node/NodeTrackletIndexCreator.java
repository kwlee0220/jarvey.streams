 ...
 */
@Command(name="node-tracklet-index-builder",
			parameterListHeading = "Parameters:%n",
			optionListHeading = "Options:%n",
			description="Build a index table for node-tracklet")
public final class NodeTrackletIndexCreator implements Runnable {
	private static final Logger s_logger = LoggerFactory.getLogger(NodeTrackletIndexCreator.class);
	...
	public NodeTrackletIndexCreator setInputTopic(String topic) {
		m_inputTopic = topic;
	...
	public NodeTrackletIndexCreator setIndexTableName(String tblName) {
	...
	public NodeTrackletIndexCreator setAutoOffsetReset(AutoOffsetReset reset) {
	...
	public Topology build() {
		...
		if ( !m_useMockStateStore ) {
			...
			builder.addStateStore(Stores.keyValueStoreBuilder(
														...
														Serdes.String(), JarveySerdes.NodeTrackletIndex()));
		}
		...
		builder
			...
			.flatTransformValues(() -> new NodeTrackletIndexCollector(STORE_INDEXES, m_timeToLive, m_useMockStateStore,
